...
naics2loop      = ('812320','32311/','3222//','236///','233///','811121','4411//','4412//','336411','3365//','3366//','488390','339///','3369//','811///','3133//','332812','2373//','321///','337110','337121','337122','337211','337212','337124','337214','337215','322///','325992','33243/','333///','3352//','331318','3314//','33592/','335311','3361//','3362//','3363//')
...
for loopnaics in naics2loop:
    ...
    for loopyears in years2loop:
        ...
        if loopyears=='00' or loopyears=='01' or loopyears=='02' or loopyears=='03' or loopyears=='04' or loopyears=='05' or loopyears=='06' or loopyears=='18':
        ...
        emp_fips   = emp_fips[emp_index[:]==loopnaics]
        emp_data   = emp_data[emp_index[:]==loopnaics]
        emp_flag   = emp_flag[emp_index[:]==loopnaics]
        ####################################################################################################
    ...
    output_file   = './processed/county_employment_'+str(naicscounter)+'.csv'
    ...
    ### 
    headerline1   = 'fipstate,fipscty,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018'
    output_file   = './processed/state_employment_'+str(naicscounter)+'.csv'
